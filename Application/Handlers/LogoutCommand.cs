...
public record LogoutCommand(Guid UserId, string DeviceType) : IRequest<AuthResponseDto>;
    ...
    : IRequestHandler<LogoutCommand, AuthResponseDto>
{
    ...
    {
        return await authService.LogoutAsync(request.UserId, request.DeviceType, ct);
    }
}
